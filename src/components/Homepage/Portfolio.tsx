...
import {
  projects,
  portfolioData,
} from "../../constants/Homepage/portfolioData";

const Portfolio: React.FC = () => {
  return (
    <section
      id="projects"
      className="min-h-screen bg-primary py-10 md:py-20 px-6 md:px-12"
    >
      <div className="max-w-6xl mx-auto px-4">
        {/* Section Header */}
        <div className="flex flex-col items-center mb-10 md:mb-20 ">
          <h2 className="text-4xl font-bold text-white text-center mb-4">
            {portfolioData.section.title}
          </h2>
            ...
            >
              ...
              <div className="lg:w-1/2 flex items-center justify-center hidden md:block">
                ...
                >
                  ...
                  <div
                    className={`absolute w-5/6 h-full rounded-lg border-2 border-white/20 shadow-lg
                    ${
                      idx % 2 === 0
                  ...
                  {/* Main content (image) */}
                  <div
                    className={`relative z-10 overflow-hidden rounded-lg w-5/6 border border-white/20 shadow-lg
                    ${idx % 2 === 0 ? "mr-0" : "ml-0"}`}
                  >
                    <img
                      src={project.image}
